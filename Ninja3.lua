...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Ninja3.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NE", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Ninja3 -X kill
screen -S Ninja3 ./Ninja3
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/sourceninjaiq/Files_Ninja3/master/File_Bot/games.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/sourceninjaiq/Files_Ninja3/master/File_Bot/Reply.lua") 
...
local Ninja3_Msg = ''  
if msgs < 100 then 
Ninja3_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
Ninja3_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
Ninja3_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
Ninja3_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
Ninja3_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
Ninja3_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
Ninja3_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
Ninja3_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
Ninja3_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Ninja3_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Ninja3_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Ninja3_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Ninja3_Msg = 'رب التفاعل✔️😍'  
end 
return Ninja3_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceNinja3(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Ninja3_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'⌯┇ عدد المجموعات الان » { '..#group..' }'..Ninja3k..''..Ninja3..'\n*⌯┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⌯┇ العضو » ['..result.title_..'](t.me/'..(username or 'ninjaIAQ')..')'
...
usertext = '\n⌯┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ninjaIAQ')..')'
status  = '\n⌯┇ تم ترقيته مطور في البوت'
...
--------------------------------------------------------------------------------------------------------------
if Ninja3_Msg and not Special(msg) then  
local Ninja3_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Ninja3_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌯┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯┇["..Ninja3_Msg.."] \n") 
else
send(msg.chat_id_,0,"⌯┇العضو : {["..data.first_name_.."](T.ME/ninjaIAQ)}\n⌯┇["..Ninja3_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌯┇عذرا يا » {["..data.first_name_.."](T.ME/ninjaIAQ)}\n⌯┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌯┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ninjaIAQ')..') \n⌯┇ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ninjaIAQ')..') \n⌯┇ تـم قفـل التاك بالكتم\n⌯┇ الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/sourceninjaiq/Files_Ninja3/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌯┇ اهلا بك في متجر ملفات نينجا\n⌯┇ ملفات السورس ↓\nٴ… … … … … … … … … … … … …\n\n"
local TextE = "\nٴ… … … … … … … … … … … … …\n⌯┇  علامة تعني { ✓ } ملف مفعل\n⌯┇ علامة تعني { ✘ } ملف معطل\n⌯┇ قناة سورس نينجا ↓\n".."⌯┇ [اضغط هنا لدخول](t.me/ninjaIAQ) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/sourceninjaiq/Files_Ninja3/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('Ninja3.lua')  
else
send(msg.chat_id_, msg.id_,"⌯┇ عذرا هاذا ملف ليس من ملفات سورس نينجا\n") 
end
return false
end
...
local UserName = (b.username_ or "ninjaIAQ")
...
' }\n'..'⌯┇ الايدي بالصوره ← { '..idph..
' }\n'..'⌯┇ الرفع ← { '..setadd..
' }\n'..'⌯┇ الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n⌯┇ CH » [𝐂𝐡𝐚𝐚𝐧𝐞𝐥 NinjaIQ 🦅](https://t.me/ninjaIAQ)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
t = "\n⌯┇ قائمة المنع \nٴ… … … … … … … … … … … … …\n"
for k,v in pairs(list) do  
local Ninja3_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Ninja3_Msg..'}\n'    
end  
if #list == 0 then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ninjaIAQ')..') \n⌯┇ تـم قفـل التفليش\n⌯┇ الحاله ← المسح ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌯┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ninjaIAQ')..')'..'\n⌯┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..Ninja3_Msg[math.random(#Ninja3_Msg)]..']') 
return false
end
...
Ninja3 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Ninja3)
...
--------------------------------------------------------------------------------------------------------------
SourceNinja3(data.message_,data)
...
------------------------------------------------------------------------
local Ninja3bot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Ninja3bot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌯┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯┇["..Ninja3bot.."] \n") 
